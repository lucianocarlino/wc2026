...
home_model.compile(optimizer="adam", loss="mse", metrics=["mae"])
away_model.compile(optimizer="adam", loss="mse", metrics=["mae"])
...
home_model.save("models/home_modelV2.keras")
away_model.save("models/away_modelV2.keras")

joblib.dump(preprocess, "models/preprocessV2.pkl")